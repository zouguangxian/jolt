...
macro_rules! jolt_print {
    ($($arg:tt)*) => {{
        use core::fmt::Write;
        let _ = write!($crate::platform::ecall::StdoutWriter, $($arg)*);
    }};
}
...
macro_rules! jolt_println {
    ...
    ($($arg:tt)*) => {{
        use core::fmt::Write;
        let _ = writeln!($crate::platform::ecall::StdoutWriter, $($arg)*);
    }};
}
...
macro_rules! eprintln {
    () => {{
        use core::fmt::Write;
        let _ = writeln!($crate::platform::ecall::StderrWriter);
    }};
    ($($arg:tt)*) => {{
        use core::fmt::Write;
        let _ = writeln!($crate::platform::ecall::StderrWriter, $($arg)*);
    }};
}
